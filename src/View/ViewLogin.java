...
public class ViewLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Acesso");
        setIconImage(new javax.swing.ImageIcon(getClass().getResource("/Images/logo-login.png")).getImage());
        setResizable(false);

        jPanel1.setPreferredSize(new java.awt.Dimension(400, 179));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (dAO.list(jTextField1.getText(), jPasswordField1.getText())) {
